...
import FieldSynchronousNew from './FieldSynchronousNew';
...
export default function List(): React.ReactNode {
    ...
    return <>
        <Modal
            ...
            <FieldSynchronousNew getLoading={(loading) => setConfirmLoading(loading)} rowId={rowId} type={type} ref={ref} />
        </Modal>
        <Page
