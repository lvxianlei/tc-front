...
export default function WeighingNew(): React.ReactNode {
    ...
    return <>
        <DetailContent operation={ [
            ...
            <CommonTable columns={ tableColumns } dataSource={ detailData.statusRecordList } pagination={ false }  rowSelection={ { selectedRowKeys: selectedRowKeys || [], onChange: (selectedKeys: [], selectedRows: []) => {
