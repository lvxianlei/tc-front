        ...
        },
        {
            ...
            render: (_: undefined, record: Record<string, any>): React.ReactNode => (
                <Space direction="horizontal" size="small">
                    <Button type='link' onClick={()=>{ history.push(`/deliveryPlan/detail/${ record.id }` )}}>查看</Button>
                    <Button type='link' onClick={()=>{ history.push(`/deliveryPlan/delivery/${ record.id }` )}}>成品出库</Button>
                </Space>
            )
        }
    ]
