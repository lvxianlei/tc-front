  ...
  constructor(props: IWithSectionModalRouteProps) {
        ...
        gantt.config.columns = [
          ...
          {label:'操作',name: "buttons",width: 150, align: "center", template: function (task:any) {
            if(task.parent){
              ...
              return (
                `
                <a style="color:#FF8C00" id="planEdit" href='/planProd/planMgmt/detail/${task.id}/${task.planId}'>派工</a>
                `
              );
            }else{
              return '-'
    ...
    render() {
      return (<>
        ...
        <div id="processingTask" style={{width:'calc(100vw - 280px)', height:'800px'}}></div>
        </>
      );
    }
  }
