            ...
            columns={[
                ...
                ...plan,
                {
                    ...
                    render: (_: undefined, record: any): React.ReactNode => (
                        <>
                            <Button type="link" style={{marginRight: 12}} size="small"><Link to={`/socialSecurity/plan/detail/${record.id}`}>查看</Link></Button>
                            <Button type="link" style={{marginRight: 12}} size="small"><Link to={`/socialSecurity/plan/edit/${record.id}`}>编辑</Link></Button>
                            <Button type="link" style={{marginRight: 12}} size="small" disabled={record.status === 1} onClick={() => handleSwichChange(record.id, true)}>启用</Button>
