 ...
 */
 ...
 class ApprovalMngt extends AbstractMngtComponent<IClientMngtWithRouteProps, IClientMngtState> {
 ...
 export default withRouter(withTranslation(['translation'])(ApprovalMngt));