...
class ApprovalMngtDetail extends AbstractDetailComponent<IContractDetailRouteProps, IContractDetailState> {
...
export default withRouter(withTranslation()(ApprovalMngtDetail));