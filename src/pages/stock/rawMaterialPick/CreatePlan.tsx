...
export default function CreatePlan(props: any): JSX.Element {
    ...
    const performanceBondChange = (fields: { [key: string]: any }, allFields: { [key: string]: any }) => {
        // if (fields.pickingType===2||fields.pickingType===0) {
        //     // if(fields.pickingType===2){
        //     //     setType(2)
        //     // }else{
        //     //     setType(0)
        //     // }
            ...
            <Spin spinning={loading}>
                ...
                <BaseInfo
                    ...
                    columns={baseInfoColumn.map((item: any) => {
                        ...
                        //     return ({
                        //         ...item, 
                        //         // required: addCollectionForm.getFieldValue('pickingType') === 0,
                        //         // disabled: addCollectionForm.getFieldValue('pickingType') === 2
                        //     })
                        // }
            ...
            >
                <PopTableContent
                    data={{
                        ...
                        path: `${addDetailMaterial.path}?outStockItemStatus=2&pickingType=0`
                    }}
                    value={{
                        id: "",
                        records: popDataList,
