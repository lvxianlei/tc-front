...
import ContractSummary, { IContractBaseInfo } from './ContractSummary';
...
interface IDetail extends IContractBaseInfo, IContract, IContractAttachment, IContractRefundRecord {
