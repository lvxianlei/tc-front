...
import { Table, Checkbox, Space, Button, Modal, Form, Input, TabsProps, message } from 'antd';
    ...
    public onSortEnd = (index: number) => {
        return async (props: { oldIndex: number; newIndex: number; }) => {
            ...
            if (oldIndex !== newIndex) {
                const newDictDataSource = dictDataSource.map((item: IDictDataSourceData, index: number) => {
