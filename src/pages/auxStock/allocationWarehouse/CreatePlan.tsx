...
import AuthUtil from '@utils/AuthUtil';
 ...
 export default function CreatePlan(props: any): JSX.Element {
     ...
     const { loading: saveLoading, run: saveRun } = useRequest<{ [key: string]: any }>((save: any) => new Promise(async (resove, reject) => {
         try {
             const path = '/tower-storage/auxiliaryAllocationStock'
     ...
     const { loading: submitLoading, run: submitRun } = useRequest<{ [key: string]: any }>((submit: any) => new Promise(async (resove, reject) => {
         try {
             const path = '/tower-storage/auxiliaryAllocationStock'
     ...
     const { loading, data } = useRequest<{ [key: string]: any }>(() => new Promise(async (resole, reject) => {
         try {
             const result: { [key: string]: any } = await RequestUtil.get(`/tower-storage/auxiliaryAllocationStock/detail/${props.id}`)
