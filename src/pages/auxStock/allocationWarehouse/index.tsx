...
export default function RawMaterialWarehousing(): React.ReactNode {
    ...
    const [pagePath, setPagePath] = useState<string>("/tower-storage/auxiliaryAllocationStock")
