...
class ManagementDetail extends AbstractDetailComponent<IContractDetailRouteProps, IContractDetailState> {
...
export default withRouter(withTranslation()(ManagementDetail));