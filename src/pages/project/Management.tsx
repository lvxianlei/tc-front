 ...
 */
 ...
 class Management extends AbstractMngtComponent<IClientMngtWithRouteProps, IClientMngtState> {
 ...
 export default withRouter(withTranslation(['translation'])(Management));