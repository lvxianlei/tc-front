...
const EditableProTableListItem: React.FC<any> = forwardRef(({ data, index }, ref) => {
    ...
    const handleChange = (fields: any, allfields: any) => {
        ...
        const gbq_bce_bl: number = processingNumber(allValue.gbq_bce_bl + "");
        const jgq_dfj: number = processingNumber(allValue.jgq_dfj + "");
        const jgq_dfj_bl: number = processingNumber(allValue.jgq_dfj_bl + "");
        const jgq_dbj: number = processingNumber(allValue.jgq_dbj + "");
        const jgq_dbj_bl: number = processingNumber(allValue.jgq_dbj_bl + "");
        const jgq_cee: number = processingNumber(allValue.jgq_cee + "");
