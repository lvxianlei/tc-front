 ...
 */
 ...
 import AbstractTaxkInformationchange, { IAbstractContractSettingState, IContract, IPaymentPlanDto } from './AbstractTaxkInformationchange';
 ...
 export interface IContractSettingState extends IAbstractContractSettingState {}
   ...
   * Contract Setting
   */
 class ContractSetting extends AbstractTaxkInformationchange<IContractSettingRouteProps, IContractSettingState> {
