 ...
 */
 ...
 import AbstractTaxkchange, { IAbstractContractSettingState, IContract, IPaymentPlanDto } from './AbstractTaxkchange';
 ...
 export interface IContractSettingState extends IAbstractContractSettingState {}
   ...
   * Contract Setting
   */
 class ContractSetting extends AbstractTaxkchange<IContractSettingRouteProps, IContractSettingState> {
