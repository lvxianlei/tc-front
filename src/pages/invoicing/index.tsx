        ...
        columns={[
            ...
            }),
            {
                ...
                render: (_: any, record: any) => {
                    return <>
                        <Button type="link" className="btn-operation-link" onClick={() => history.push(`/invoicing/taskInfo/${record.id}`)}>查看任务信息</Button>
                        {record.taskType === 1 && <Button type="link" className="btn-operation-link" onClick={() => history.push(`/invoicing/edit/${record.id}`)}>填写开票信息</Button>}
