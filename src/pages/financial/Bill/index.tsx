            ...
            columns={[
                ...
                }),
                {
                    ...
                    render: (_: any, record: any) => {
                        return <>
                            <Button type="link" style={{marginRight: 12}} disabled={![1].includes(record.invoiceStatus)} onClick={() => {
                                setType("edit")
                            ...
                            <Button type="link" style={{marginRight: 12}} disabled={![1].includes(record.invoiceStatus)} onClick={() => handleCancel(record.id)}>作废</Button>
