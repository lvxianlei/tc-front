        ...
        <div className={styles.check}>
            ...
            <Page
                ...
                extraOperation={
                    ...
                    <span>小样图数：{headerName?.uploadSmallSampleCount}/{(headerName?.uploadSmallSampleCount&&headerName?.uploadSmallSampleCount!==0?headerName?.uploadSmallSampleCount:0)+(headerName?.noSmallSampleCount&&headerName?.noSmallSampleCount!==-1?headerName?.noSmallSampleCount:0)}</span>
                    </Space>
                }
                tableProps={{
                    onRow:(record:any) => ({
