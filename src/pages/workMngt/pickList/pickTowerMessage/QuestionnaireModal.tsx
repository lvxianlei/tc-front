                ...
                <DetailContent>
                    ...
                    <Form ref={ this.form } labelCol={{ span: 4 }} className={ styles.topPadding }>
                        <Form.Item name="description" label="备注" initialValue={ record.description }>
                            <Input.TextArea maxLength={ 300 } placeholder="请输入备注信息" rows={ 1 } showCount disabled={ this.props.title==='查看问题单'} />
                        </Form.Item>
                        <Form.Item name="newValue" label="校对后信息"
                            ...
                            <Input maxLength={ 100 } placeholder="请输入" disabled={ this.props.title==='查看问题单' } />
                        </Form.Item>
                    </Form>
