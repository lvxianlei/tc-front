            ...
            <PopTableContent
                ...
                onChange={(fields: any[]) => {
                    setMaterialList(fields.map((item: any) => ({
                        ...
                        standard: item?.standard ? item?.standard : (materialStandardOptions && materialStandardOptions.length > 0) ?  materialStandardOptions[0]?.id : "",
                        ...
                        materialTextureId: item?.structureTextureId ? item?.structureTextureId : (materialTextureOptions && materialTextureOptions.length > 0) ?  materialTextureOptions[0]?.id : "",
