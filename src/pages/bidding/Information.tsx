...
class Information extends AbstractMngtComponent<IClientMngtWithRouteProps, IClientMngtState> {
...
export default withRouter(withTranslation(['translation'])(Information));