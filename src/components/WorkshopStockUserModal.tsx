 ...
 */
 ...
 export interface IWorkshopStockUserSelectionComponentState extends IAbstractSelectableModalState {
     readonly tableDataSource: any[];
 }
 export interface IWorkshopStockUserSelectionComponentProps extends IAbstractSelectableModalProps {
  ...
  */
 export default class WorkshopStockUserSelectionComponent extends AbstractFilteredSelecableModal<IWorkshopStockUserSelectionComponentProps, IWorkshopStockUserSelectionComponentState> {
      ...
      * @returns state 
      */
     protected getState(): IWorkshopStockUserSelectionComponentState {
         return {
             ...super.getState(),
             tablePagination: {
                 current: 1,
     ...
     public async getTable(filterValues: Record<string, any>, pagination: TablePaginationConfig = {}) {
         ...
         selectKeys?.forEach((item: any) => {
             newData = newData.filter((res:any) => res.id !== item.userId);
         })
         this.setState({
             ...filterValues,
